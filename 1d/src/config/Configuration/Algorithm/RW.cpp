...
// Check if the length of the random walk has reached the maximum length
        // 8
        if((abs(string_head) >= 8 ) && flag_8 == false)
        {
            flag_8 = true;
        ...
        // 16
        if((abs(string_head) >= 16 ) && flag_16 == false)
        {
            flag_16 = true;
        ...
        // 32
        if((abs(string_head) >= 32 ) && flag_32 == false)
        {
            flag_32 = true;
        ...
        // 64
        if((abs(string_head) >= 64 ) && flag_64 == false)
        {
            flag_64 = true;
        ...
        // 128
        if((abs(string_head) >= 128 ) && flag_128 == false)
        {
            flag_128 = true;
        ...
        // 256
        if((abs(string_head) >= 256 ) && flag_256 == false)
        {
            flag_256 = true;
        ...
        // 512
        if((abs(string_head) >= 512 ) && flag_512 == false)
        {
            flag_512 = true;
        ...
        // 1024
        if((abs(string_head) >= 1024 ) && flag_1024 == false)
        {
            flag_1024 = true;
        ...
        // 2048
        if((abs(string_head) >= 2048 ) && flag_2048 == false)
        {
            flag_2048 = true;
        ...
        // 4096
        if((abs(string_head) >= 4096 ) && flag_4096 == false)
        {
            flag_4096 = true;
        ...
        // 8192
        if((abs(string_head) >= 8192 ) && flag_8192 == false)
        {
            flag_8192 = true;
        ...
        // 16384
        if((abs(string_head) >= 16384 ) && flag_16384 == false)
        {
            flag_16384 = true;
        ...
        // 32768
        if((abs(string_head) >= 32768 ) && flag_32768 == false)
        {
            flag_32768 = true;
