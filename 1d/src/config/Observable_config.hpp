...
void Observable::initObservable()  // add addBasicObser() & addCombiObser()
{
	...
	addBasicObser(para.i_Cma_8        	 , "Cma_8"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma_16          , "Cma_16"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma_32          , "Cma_32"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma_64          , "Cma_64"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma_128         , "Cma_128"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma_256         , "Cma_256"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma_512         , "Cma_512"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma_1024        , "Cma_1024"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma_2048        , "Cma_2048"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma_4096        , "Cma_4096"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma_8192        , "Cma_8192"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma_16384       , "Cma_16384"       	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma_32768       , "Cma_32768"       	, ""    				, 0     , 1.0      					);
	...
	addBasicObser(para.i_Cma2_8           , "Cma2_8"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma2_16          , "Cma2_16"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma2_32          , "Cma2_32"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma2_64          , "Cma2_64"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma2_128         , "Cma2_128"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma2_256         , "Cma2_256"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma2_512         , "Cma2_512"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma2_1024        , "Cma2_1024"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma2_2048        , "Cma2_2048"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma2_4096        , "Cma2_4096"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma2_8192        , "Cma2_8192"        	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma2_16384       , "Cma2_16384"       	, ""    				, 0     , 1.0      					);
	addBasicObser(para.i_Cma2_32768       , "Cma2_32768"       	, ""    				, 0     , 1.0      					);
	...
	addCombiObser(para.i_CmaQ_8        	  , "CmaQ_8"        	, ""    				, 0     , 1.0      					);
	addCombiObser(para.i_CmaQ_16          , "CmaQ_16"        	, ""    				, 0     , 1.0      					);
	addCombiObser(para.i_CmaQ_32          , "CmaQ_32"        	, ""    				, 0     , 1.0      					);
	addCombiObser(para.i_CmaQ_64          , "CmaQ_64"        	, ""    				, 0     , 1.0      					);
	addCombiObser(para.i_CmaQ_128         , "CmaQ_128"        	, ""    				, 0     , 1.0      					);
	addCombiObser(para.i_CmaQ_256         , "CmaQ_256"        	, ""    				, 0     , 1.0      					);
	addCombiObser(para.i_CmaQ_512         , "CmaQ_512"        	, ""    				, 0     , 1.0      					);
	addCombiObser(para.i_CmaQ_1024        , "CmaQ_1024"        	, ""    				, 0     , 1.0      					);
	addCombiObser(para.i_CmaQ_2048        , "CmaQ_2048"        	, ""    				, 0     , 1.0      					);
	addCombiObser(para.i_CmaQ_4096        , "CmaQ_4096"        	, ""    				, 0     , 1.0      					);
	addCombiObser(para.i_CmaQ_8192        , "CmaQ_8192"        	, ""    				, 0     , 1.0      					);
	addCombiObser(para.i_CmaQ_16384       , "CmaQ_16384"       	, ""    				, 0     , 1.0      					);
	addCombiObser(para.i_CmaQ_32768       , "CmaQ_32768"       	, ""    				, 0     , 1.0      					);
...
void Observable::calCombiObser()  // add Result[]
{
	...
	Result[para.i_CmaQ_8] = Ob[para.i_Cma_8] * Ob[para.i_Cma_8] / Ob[para.i_Cma2_8];
	Result[para.i_CmaQ_16] = Ob[para.i_Cma_16] * Ob[para.i_Cma_16] / Ob[para.i_Cma2_16];
	Result[para.i_CmaQ_32] = Ob[para.i_Cma_32] * Ob[para.i_Cma_32] / Ob[para.i_Cma2_32];
	Result[para.i_CmaQ_64] = Ob[para.i_Cma_64] * Ob[para.i_Cma_64] / Ob[para.i_Cma2_64];
	Result[para.i_CmaQ_128] = Ob[para.i_Cma_128] * Ob[para.i_Cma_128] / Ob[para.i_Cma2_128];
	Result[para.i_CmaQ_256] = Ob[para.i_Cma_256] * Ob[para.i_Cma_256] / Ob[para.i_Cma2_256];
	Result[para.i_CmaQ_512] = Ob[para.i_Cma_512] * Ob[para.i_Cma_512] / Ob[para.i_Cma2_512];
	Result[para.i_CmaQ_1024] = Ob[para.i_Cma_1024] * Ob[para.i_Cma_1024] / Ob[para.i_Cma2_1024];
	Result[para.i_CmaQ_2048] = Ob[para.i_Cma_2048] * Ob[para.i_Cma_2048] / Ob[para.i_Cma2_2048];
	Result[para.i_CmaQ_4096] = Ob[para.i_Cma_4096] * Ob[para.i_Cma_4096] / Ob[para.i_Cma2_4096];
	Result[para.i_CmaQ_8192] = Ob[para.i_Cma_8192] * Ob[para.i_Cma_8192] / Ob[para.i_Cma2_8192];
	Result[para.i_CmaQ_16384] = Ob[para.i_Cma_16384] * Ob[para.i_Cma_16384] / Ob[para.i_Cma2_16384];
	Result[para.i_CmaQ_32768] = Ob[para.i_Cma_32768] * Ob[para.i_Cma_32768] / Ob[para.i_Cma2_32768];
