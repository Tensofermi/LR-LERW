def reformat_data(input_file, output_file):
    # 定义需要提取的长度值
    lengths = [8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768]
...
if __name__ == "__main__":
    sigma_list = ['0.100', '0.200', '0.300', '0.400', '0.500', '0.600', '0.700', '0.800', '0.900', '1.000', '1.100', '1.200', '1.300', '1.400', '1.500', '1.600', '1.700', '1.800', '1.900', '2.000', '2.200', '2.500', '1000000.000']
